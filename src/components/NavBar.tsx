...
export function NavbarDefault() {
    ...
    return (
        <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none  bg-gradient-to-r from-neutral-50 to-teal-50">
            <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
                <Typography
                    as="a"
                    href="#"
                    variant={"h4"}
                    className="mr-4 cursor-pointer py-1.5 font-bold  from-gray-900 to-gray-600 bg-gradient-to-r text-transparent bg-clip-text"
                >
                    Indegate Consulting
                </Typography>
